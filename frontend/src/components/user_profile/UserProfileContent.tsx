...
export default function UserProfileContent() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        const getFallbackValue = (value: string | undefined | null, fallback: string | undefined | null): string | null => {
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                        <h2 className="text-2xl font-bold mb-4">{user.first_name} {user.last_name}</h2>
            ...
            >
                <div className="w-1/4">
                    ...
                    <div className="flex flex-col space-y-4">
                        <span className="text-gray-800 font-semibold cursor-pointer">Edit Password</span>
                        <span className="text-gray-800 font-semibold cursor-pointer">Notifications</span>
                        <span className="text-gray-800 font-semibold cursor-pointer">Billing</span>
