...
export default function TransactionForm() {
  ...
  const handleNextClick = () => {
    ...
    const generalFieldsToValidate: Array<keyof z.infer<typeof formSchema>> = ["description", "amount", "date", "contact_id"];
    
    Promise.all(generalFieldsToValidate.map(field => form.trigger(field))).then(
      (results) => {
