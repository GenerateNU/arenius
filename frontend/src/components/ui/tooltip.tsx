...
//       {isVisible && (
//         <div className="absolute z-10 px-4 py-3 text-sm text-gray-700 bg-white rounded-md shadow-md transform bottom-full mb-2 -translate-x-5 left-0 w-64 md:w-80 border border-gray-100">
...
//             </React.Fragment>
//           ) : (
//             <React.Fragment>{textContent as string}</React.Fragment> // Fallback to plain text if not structured
//           )}
