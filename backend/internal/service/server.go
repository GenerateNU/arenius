...
func SetupApp(config config.Config, repo *storage.Repository, climatiqClient *climatiq.Client) *fiber.App {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     "http://localhost:3000,http://localhost:8080,https://arenius.onrender.com,https://arenius-pr-126.onrender.com,https://seal-app-lfnhy.ondigitalocean.app,https://.onrender.com,https://sea-lion-app-y4r7v.ondigitalocean.app/,https://.ondigitalocean.app/,.ondigitalocean.app", // Allow any source domain to access API
